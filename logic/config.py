...
if os.name == "posix":
    ...
    pswds_folder = os.path.join(current_directory, "pswds")

    if not os.path.exists(pswds_folder):
        os.makedirs(pswds_folder)
    USER_LIST = os.path.join(pswds_folder, "users.jett")
    DUMP_DIRECTORY = pswds_folder
else:
    USER_LIST = "E:/!dump/JettpassGUI/pswds/users.jett" #for me 
